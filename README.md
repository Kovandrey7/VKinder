...
## Добавление личных данных в папку config.py
group_token = "указать токен сообщества"

user_token = "указать токен пользователя"

bd_login = "указать логин от базы данных"

bd_password = "указать пароль от базы данных"

bd_name = "указать название базы данных"
